...
class Lesson16 extends Lesson {
  ...
  Lesson16() {
    ...
    var uniforms = ['uPMatrix', 'uMVMatrix', 'uNMatrix', 'uUseTextures', 'uMaterialAmbientColor', 'uMaterialDiffuseColor', 'uMaterialSpecularColor', 'uMaterialShininess', 'uMaterialEmissiveColor', 'uPointLightingDiffuseColor', 'uPointLightingLocation', 'uPointLightingSpecularColor', 'uShowSpecularHighlights', 'uSampler', 'uAmbientLightingColor'];
    ...
    gl.texImage2DTyped(TEXTURE_2D, 0, RGBA, rttWidth, rttHeight, 0, RGBA, UNSIGNED_BYTE, null);

    renderbuffer = gl.createRenderbuffer();
    gl.bindRenderbuffer(RENDERBUFFER, renderbuffer);
    gl.renderbufferStorage(RENDERBUFFER, DEPTH_COMPONENT16, rttWidth, rttHeight);

    gl.framebufferTexture2D(FRAMEBUFFER, COLOR_ATTACHMENT0, TEXTURE_2D, rttTexture, 0);
  ...
  void drawScene(num viewWidth, num viewHeight, num aspect) {
    ...
    laptopScreen.draw(vertex: aVertexPosition, normal: aVertexNormal, coord: aTextureCoord, setUniforms: setMatrixUniforms);
